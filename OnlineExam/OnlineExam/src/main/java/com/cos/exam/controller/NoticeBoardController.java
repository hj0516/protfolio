	...
	public String findById(@PathVariable int id, Model model) {
		...
		model.addAttribute("nboard", boardService.공지보기(id));
	     ...
	     String str2 = "다음글이 없습니다.";
	      ...
	      if((id-1) == 0) {
	         model.addAttribute("nboard_pre", str);
	      } else {
	         model.addAttribute("nboard_pre", boardService.공지보기(id-1));
	      }
	      try {
	         model.addAttribute("nboard_nxt", boardService.공지보기(id+1));
	      } catch(IllegalIdentifierException e) {
	         model.addAttribute("nboard_nxt", str2);
	      }
